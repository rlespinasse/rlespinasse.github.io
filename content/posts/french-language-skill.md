...
| :--- | :--- |
| Introduction d'une liste ou d'une explication | deux-points (`:`) |
| Digression ou précision | parenthèses `(…)` |
| Deux propositions liées | point ou virgule |
| Mise en emphase encadrante | virgules ou suppression |
